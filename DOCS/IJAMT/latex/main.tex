...
\begin{center}\includegraphics[width=6.26806in,height=2.63889in]{figures/image1.png}\end{center}
...
\begin{center}\includegraphics[width=6.26806in,height=2.60069in]{figures/image3.png}\end{center}
...
\begin{center}\includegraphics[width=5.83333in,height=2.44375in]{figures/image5.png}\end{center}



{\small \textbf{Fig. 3} The per-column Z-envelope. The three panels share one
...
\begin{center}\includegraphics[width=5.83333in,height=2.44375in]{figures/image7.png}\end{center}



{\small \textbf{Fig. 4} Tube pruning. (a) A long diagonal segment seen from
...
\begin{center}\includegraphics[width=5.83333in,height=2.47292in]{figures/image9.png}\end{center}



{\small \textbf{Fig. 5} Mapping compute threads onto the workpiece column grid.
...
\begin{center}\includegraphics[width=5.83333in,height=6.49375in]{figures/image10.png}\end{center}



{\small \textbf{Fig. 6} Per-thread control flow of subtract\_swept.comp, with
...
{\small \textbf{Table 1} Tube pruning on the two diagonal stress benchmarks: net
...
\begin{center}\includegraphics[width=6.26806in,height=2.19792in]{figures/image12.png}\end{center}



{\small \textbf{Fig. 7} Tube pruning on the stress benchmarks, normalized to the
...
{\small \textbf{Table 2} Four-level ablation on the control (square\_600,
...
{\small \textbf{Table 3} Net carving time (ms) per machining workload and
...
\begin{center}\includegraphics[width=6.26806in,height=4.53333in]{figures/image14.png}\end{center}
...
{\small \textbf{Table 4} Resident footprint and data movement, per level
(reference stock)}
...
{\small \textbf{Table 5} The zero-fill lever and the best available
