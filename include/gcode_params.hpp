...
#define CLEAR_COLOR 0.1f, 0.1f, 0.1f, 1.f
#define TOOLPATH_COLOR glm::vec4(0.0f, 1.0f, 0.0f, 1.0f)
#define RED_COLOR glm::vec4(1.0f, 0.0f, 0.0f, 1.0f)
#define GREEN_COLOR glm::vec4(0.0f, 1.0f, 0.0f, 1.0f)
#define BLUE_COLOR glm::vec4(0.0f, 0.0f, 1.0f, 1.0f)

// Mouse interaction
#define INITIAL_WINDOW_WIDTH 1200  // Initial window width
#define INITIAL_WINDOW_HEIGHT 720  // Initial window height
